...
# Do some basic sanity checking to make sure that the appropriate versions of fabric images are available.
...
function networkDown() {
  IMAGE_TAG=$IMAGETAG docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_CA down --volumes --remove-orphans
