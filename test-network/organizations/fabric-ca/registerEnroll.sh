...
function createOrg1() {
  ...
  mv ${PWD}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/* ${PWD}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/key.pem
...
function createOrg2() {
  ...
  mv ${PWD}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/* ${PWD}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/key.pem
...
function createOrg3() {
  ...
  mv ${PWD}/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/keystore/* ${PWD}/organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/keystore/key.pem
...
function createOrg4() {
  ...
  mv ${PWD}/organizations/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp/keystore/* ${PWD}/organizations/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp/keystore/key.pem
