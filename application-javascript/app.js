...
async function main() {
	try {
		...
		try {
			...
			console.log('\n--> Evaluate Transaction: ReadVote returns the vote stored in the world state with given id.');
			let result = await contract.evaluateTransaction('ReadVote', 'vote1');
			...
			console.log('\n--> Evaluate Transaction: ReadVote returns the vote stored in the world state with given id.');
			result = await contract.evaluateTransaction('ReadVote', 'vote1');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);
